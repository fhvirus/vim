nmap <buffer> <F4> :%d<CR>:r owoPATH/templates/template.cpp<CR>kJ19zF23G
nmap <buffer> <F5> :%d<CR>:r owoPATH/templates/minimum.cpp<CR>kJ5G
nmap <buffer> <F6> :vs owoPATH/in.in<CR>:vert res 30<CR>
nmap <buffer> <F7> :w<CR>:!g++ -Wall -Wconversion -Wfatal-errors -g -std=c++17 -fsanitize=undefined,address -DOWO -DNONTOI "%" -o owoPATH/run<CR>
